...
TEST(test_func_definition_1, "Test function definition 1")
	...
	scanner.stream = fopen("func_definition_1.php", "r");
	...
	free(token);
ENDTEST(scanner.stream, "func_definition_1.php")
...
TEST(test_func_definition_2, "Test function definition 2")
	...
	scanner.stream = fopen("func_definition_2.php", "r");
	...
	free(token);
ENDTEST(scanner.stream, "func_definition_2.php")
...
TEST(test_func_definition_3, "Test function definition 3")
	...
	scanner.stream = fopen("func_definition_3.php", "r");
	...
	free(token);
ENDTEST(scanner.stream, "func_definition_3.php")
...
TEST(test_func_call_1, "Test function call 1")
	...
	scanner.stream = fopen("func_call_1.php", "r");
	...
	free(token);
ENDTEST(scanner.stream, "func_call_1.php")
