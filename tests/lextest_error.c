...
TEST(test_faulty_declare, "Test faulty declare")
	...
	scanner.stream = fopen("faulty_declare.php", "r");
	Token *token = malloc(sizeof(Token));
	scanner.first_read = 1;

	TEST_ASSERT(get_token(token, &scanner) != 0)
	int a = fgetc(scanner.stream);
	while (a != '\n') {
		a = fgetc(scanner.stream);
	}
    scanner.line++;
...
ENDTEST(scanner.stream, "faulty_declare.php")
...
TEST(test_faulty_type, "Test faulty type")
	...
	scanner.stream = fopen("faulty_type.php", "r");
	Token *token = malloc(sizeof(Token));
	scanner.first_read = 1;
...
ENDTEST(scanner.stream, "faulty_type.php")
...
scanner.stream = fopen("faulty_identifier.php", "r");
Token *token = malloc(sizeof(Token));
scanner.first_read = 1;
...
ENDTEST(scanner.stream, "faulty_identifier.php")
...
scanner.stream = fopen("faulty_variable.php", "r");
Token *token = malloc(sizeof(Token));
scanner.first_read = 1;
...
ENDTEST(scanner.stream, "faulty_variable.php")
 */
...
TEST(test_faulty_number, "Test faulty number")
	...
	scanner.stream = fopen("faulty_number.php", "r");
	Token *token = malloc(sizeof(Token));
	scanner.first_read = 1;
...
ENDTEST(scanner.stream, "faulty_number.php")
...
TEST(test_faulty_characters_and_combinations, "Test faulty characters and combinations")
	...
	scanner.stream = fopen("faulty_characters_and_combinations.php", "r");
	Token *token = malloc(sizeof(Token));
	scanner.first_read = 1;
...
ENDTEST(scanner.stream, "faulty_characters_and_combinations.php")
