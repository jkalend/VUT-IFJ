...
TEST(test_greater_1, "Test greater 1")
	...
	scanner.stream = fopen("greater_1.php", "r");
	...
	free(token);
ENDTEST(scanner.stream, "greater_1.php")
...
TEST(test_greater_2, "Test greater 2")
	...
	scanner.stream = fopen("greater_2.php", "r");
	Token *token = malloc(sizeof(Token));
	scanner.first_read = 1;
	...
	free(token);
ENDTEST(scanner.stream, "greater_2.php")
...
TEST(test_greater_3, "Test greater 3")
	...
	scanner.stream = fopen("greater_3.php", "r");
	Token *token = malloc(sizeof(Token));
	scanner.first_read = 1;
	...
	free(token);
ENDTEST(scanner.stream, "greater_3.php")
...
TEST(test_lesser_1, "Test lesser 1")
	...
	scanner.stream = fopen("lesser_1.php", "r");
	Token *token = malloc(sizeof(Token));
	scanner.first_read = 1;
	...
	free(token);
ENDTEST(scanner.stream, "lesser_1.php")
...
TEST(test_lesser_2, "Test lesser 2")
	...
	scanner.stream = fopen("lesser_2.php", "r");
	Token *token = malloc(sizeof(Token));
	scanner.first_read = 1;
	...
	free(token);
ENDTEST(scanner.stream, "lesser_2.php")
...
TEST(test_lesser_3, "Test lesser 3")
	...
	scanner.stream = fopen("lesser_3.php", "r");
	Token *token = malloc(sizeof(Token));
	scanner.first_read = 1;
	...
	free(token);
ENDTEST(scanner.stream, "lesser_3.php")
...
TEST(test_greater_equal_1, "Test greater_equal 1")
	...
	scanner.stream = fopen("greater_equal_1.php", "r");
	Token *token = malloc(sizeof(Token));
	scanner.first_read = 1;
	...
	free(token);
ENDTEST(scanner.stream, "greater_equal_1.php")
...
TEST(test_greater_equal_2, "Test greater_equal 2")
	...
	scanner.stream = fopen("greater_equal_2.php", "r");
	Token *token = malloc(sizeof(Token));
	scanner.first_read = 1;
	...
	free(token);
ENDTEST(scanner.stream, "greater_equal_2.php")
...
TEST(test_greater_equal_3, "Test greater_equal 3")
	...
	scanner.stream = fopen("greater_equal_3.php", "r");
	Token *token = malloc(sizeof(Token));
	scanner.first_read = 1;
	...
	free(token);
ENDTEST(scanner.stream, "greater_equal_3.php")
...
TEST(test_lesser_equal_1, "Test lesser_equal 1")
	...
	scanner.stream = fopen("lesser_equal_1.php", "r");
	Token *token = malloc(sizeof(Token));
	scanner.first_read = 1;
	...
	free(token);
ENDTEST(scanner.stream, "lesser_equal_1.php")
...
TEST(test_lesser_equal_2, "Test lesser_equal 2")
	...
	scanner.stream = fopen("lesser_equal_2.php", "r");
	Token *token = malloc(sizeof(Token));
	scanner.first_read = 1;
	...
	free(token);
ENDTEST(scanner.stream, "lesser_equal_2.php")
...
TEST(test_lesser_equal_3, "Test lesser_equal 3")
	...
	scanner.stream = fopen("lesser_equal_3.php", "r");
	Token *token = malloc(sizeof(Token));
	scanner.first_read = 1;
	...
	free(token);
ENDTEST(scanner.stream, "lesser_equal_3.php")
...
TEST(test_equal_1, "Test equal 1")
	...
	scanner.stream = fopen("equal_1.php", "r");
	Token *token = malloc(sizeof(Token));
	scanner.first_read = 1;
	...
	free(token);
ENDTEST(scanner.stream, "equal_1.php")
...
TEST(test_equal_2, "Test equal 2")
	...
	scanner.stream = fopen("equal_2.php", "r");
	Token *token = malloc(sizeof(Token));
	scanner.first_read = 1;
	...
	free(token);
ENDTEST(scanner.stream, "equal_2.php")
...
TEST(test_equal_3, "Test equal 3")
	...
	scanner.stream = fopen("equal_3.php", "r");
	Token *token = malloc(sizeof(Token));
	scanner.first_read = 1;
	...
	free(token);
ENDTEST(scanner.stream, "equal_3.php")
...
TEST(test_not_equal_1, "Test not_equal 1")
	...
	scanner.stream = fopen("not_equal_1.php", "r");
	Token *token = malloc(sizeof(Token));
	scanner.first_read = 1;
	...
	free(token);
ENDTEST(scanner.stream, "not_equal_1.php")
...
TEST(test_not_equal_2, "Test not_equal 2")
	...
	scanner.stream = fopen("not_equal_2.php", "r");
	Token *token = malloc(sizeof(Token));
	scanner.first_read = 1;
	...
	free(token);
ENDTEST(scanner.stream, "not_equal_2.php")
...
TEST(test_not_equal_3, "Test not_equal 3")
	...
	scanner.stream = fopen("not_equal_3.php", "r");
	Token *token = malloc(sizeof(Token));
	scanner.first_read = 1;
	...
	free(token);
ENDTEST(scanner.stream, "not_equal_3.php")
