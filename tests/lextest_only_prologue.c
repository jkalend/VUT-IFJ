...
TEST(test_only_prologue_with_newline_and_spaces_and_comment,
	 "Test only prologue with newline and spaces and comment")
...
int check =
	write_file("only_prologue_with_newline_and_spaces_and_comment_and_newline_test_file.php",
			   "<?php\n   //comment  ");
if (check != 0) {
	return 1;
}
...
int check = write_file(
	"only_prologue_with_newline_and_spaces_and_comment_and_newline_and_spaces_test_file.php",
	"<?php\n   //comment \n");
if (check != 0) {
	return 1;
}
stream = fopen(
	"only_prologue_with_newline_and_spaces_and_comment_and_newline_and_spaces_test_file.php", "r");
Token *token = malloc(sizeof(Token));
TEST_ASSERT(get_token(token) == 0)
TEST_ASSERT(token->type == T_VALID)
TEST_ASSERT(token->line == 1)
...
int check = write_file(
	"only_prologue_with_newline_and_spaces_and_comment_and_newline_and_spaces_and_comment_test_file.php",
	"<?php\n   //comment \n//comment");
if (check != 0) {
	return 1;
}
...
TEST(test_only_prologue_with_newline_and_block_comments,
	 "Test only prologue with newline and block comments")
int check =
	write_file("only_prologue_with_newline_and_block_comments_test_file.php", "<?php\n/*comment*/");
if (check != 0) {
	return 1;
}
...
int check =
	write_file("only_prologue_with_newline_and_block_comments_and_newline_and_spaces_test_file.php",
			   "<?php\n/*comment*/\n   ");
if (check != 0) {
	return 1;
}
stream = fopen("only_prologue_with_newline_and_block_comments_and_newline_and_spaces_test_file.php",
			   "r");
Token *token = malloc(sizeof(Token));
TEST_ASSERT(get_token(token) == 0)
TEST_ASSERT(token->type == T_VALID)
...
free(token);
ENDTEST(stream,
		"only_prologue_with_newline_and_block_comments_and_newline_and_spaces_test_file.php")
...
int check = write_file(
	"only_prologue_with_newline_and_block_comments_and_newline_and_spaces_and_comment_test_file.php",
	"<?php\n/*comment*/\n   //comment");
if (check != 0) {
	return 1;
}
...
TEST(test_only_prologue_with_multiline_block_comment,
	 "Test only prologue with multiline block comment")
