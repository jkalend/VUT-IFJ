...
TEST(test_while_1, "Test while cycle 1")
	...
	scanner.stream = fopen("while_1.php", "r");
	...
	TEST_ASSERT(token->value.keyword == KW_WHILE)
	...
	free(token);
ENDTEST(scanner.stream, "while_1.php")
...
TEST(test_while_2, "Test while cycle 2")
	...
	scanner.stream = fopen("while_2.php", "r");
	...
	TEST_ASSERT(token->type == T_KEYWORD)
	TEST_ASSERT(token->line == 4)
	TEST_ASSERT(token->value.keyword == KW_FALSE)
	...
	free(token);
ENDTEST(scanner.stream, "while_2.php")
...
TEST(test_while_3, "Test while cycle 3")
	...
	scanner.stream = fopen("while_3.php", "r");
	...
	free(token);
ENDTEST(scanner.stream, "while_3.php")
