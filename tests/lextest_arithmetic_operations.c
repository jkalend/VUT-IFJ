...
TEST_ASSERT(token->column[0] == 10)
TEST_ASSERT(token->column[1] == 11)
TEST_ASSERT(strcmp(token->value.string, "c") == 0)
...
TEST_ASSERT(token->type == T_EQUAL)
TEST_ASSERT(token->line == 3)
TEST_ASSERT(token->column[0] == 3)
TEST_ASSERT(token->column[1] == 4)
...
TEST_ASSERT(token->type == T_PLUS)
TEST_ASSERT(token->line == 3)
TEST_ASSERT(token->column[0] == 13)
TEST_ASSERT(token->column[1] == 14)

TEST_ASSERT(get_token(token) == 0)
TEST_ASSERT(token->type == T_INT)
TEST_ASSERT(token->line == 3)
TEST_ASSERT(token->column[0] == 18)
TEST_ASSERT(token->column[1] == 20)
TEST_ASSERT(strcmp(token->value.number_int, 19) == 0)

TEST_ASSERT(get_token(token) == 0)
TEST_ASSERT(token->type == T_SEMICOLON)
TEST_ASSERT(token->line == 3)
TEST_ASSERT(token->column[0] == 20)
